...
// MobaXterm-style welcome box builder — modeled directly on the reference
// screenshot pluto supplied (2026-08-14): MAGENTA sharp-cornered frame,
// GREEN centered title with the version, white body text with colored
// keywords, green ➤ bullets, a red section header, underlined link. The
// powerline date/time/path prompt below the box comes from shellIntegration.
